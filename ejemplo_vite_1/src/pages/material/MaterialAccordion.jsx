...
const MaterialAccordion = () => {
  ...
  return (
    <>
        <Breadcrumb link={matConstants.matLink} title={matConstants.matTitle} description={matConstants.matAccordionDescription}/>
          ...
          <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
              ...
              <AccordionDetails>
                  <img src="/images/sticker-fastapi-tamila2.png" width="250" />
                  <hr />
                  <Typography>
          ...
          <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
              ...
              <AccordionDetails>
                  <img src="/images/django-tamila-750.jpg" width="250" />
                  <hr />
                  <Typography>
